...
export default defineConfig({
  ...
  reporter: [["list"], ["json", { outputFile: "../logs/photos-02.json" }]], outputDir: "../runs/photos-02",
  ...
  webServer: {
    ...
    cwd: resolve(__dirname, "../../../../game"), url: "http://127.0.0.1:5198", reuseExistingServer: false,
  },
});
