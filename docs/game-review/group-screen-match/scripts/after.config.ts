...
process.env.REVIEW_EVIDENCE = "../docs/game-review/group-screen-match/after";
process.env.HALL_CAPTURE_PHASE = "after";
export default defineConfig({
  testDir: "../../../../game/e2e", testMatch: "hall-overlay-layout.spec.ts",
  grep: /applause groom|393 cheer bride reduced/,
