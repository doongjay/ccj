...
const examples = [
  ...
  ["도착했다.다음 장소로 가자.", "도착했다.다음 장소로 가자."],
  ["도착했어요.다음 장소로 가자.", "도착했어요.\n다음 장소로 가자."],
  ["이제도착했다. 다음 장소로 가자.", "이제도착했다.\n다음 장소로 가자."],
  ["그렇구나. 다음으로 가자.", "그렇구나. 다음으로 가자."],
  ["어디로 갈까? 바로 가자!", "어디로 갈까? 바로 가자!"],
];
